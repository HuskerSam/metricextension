    ...
    return (
        <div>
            {historyEntry.results.map((result, resultIndex) => (
                <div key={historyEntry.url}>
                    <div className="py-1 flex items-center">
                        <div className="flex flex-row">
                            <a className="url_display flex-1 text-ellipsis text-blue-500 active:text-purple-500 focus:text-purple-500 self-center"
                                target="_blank"></a>
                        </div>
                    ...
                    <div className="history_entry_set_wrapper mx-1 my-1 flex flex-col">
                        <div className="flex flex-row">
                            <h6 className="history_entry_prompt_setname pl-2 pr-1 flex-1 py-2 fs-5">{historyEntry.setName}</h6>
                            <div className="whitespace-nowrap">
                                ...
                                <button className="download_full_results_btn btn_icon text-sm inline-flex m-1 mr-0 p-2" data-historyindex={historyEntry.historyIndex}>
                                    ...
                                    Full</button>D
                                <span className="history_index pr-2 font-bold inline-block w-[30px] relative top-[-4px] text-right text-slate-500">{getHistoryIndexDisplay(historyEntry.historyIndex, resultIndex, historyEntry.results)}</span>
                            </div>
                        </div>
